...
Для этого вам необходимо перейти в раздел “Финансы” в левом меню личного кабинета. Далее в поле “Продажи” нужно выбрать необходимый период и скачать файл в удобном для вас формате.   


::: note  
**Важно**: Если у вас более 20-ти продаж за выбранный период, то нужно нажать на кнопку “Показать все” перед скачиванием документа, в противном случае он будет не полным.    
:::  

::: пример /Финансы. Выгрузка по продажам.gif
...
3. Если ИНН старого и нового юридического лица отличается, то вам необходимо также заполнить соглашение, которое должно быть подписано двумя сторонами: Принципалом и Преемником.  

Подписанный документ можно направить с помощью ЭДО, тогда физическая подпись заменяется цифровой. Или с помощью почты:   
...
Если вам нужно вывести деньги со старого профиля после переноса магазина, когда расчетный счет по предыдущему юридическому или физическому лицу уже закрыт, то вам необходимо заполнить и прислать нам финансовое поручение по шаблону. Шаблон для [юридического](https://drive.google.com/uc?export=download&confirm=no_antivirus&id=1KtGAXbfUMp-lEvaryMRCcNURxNQYULRb) и для [физического](https://drive.google.com/uc?export=download&confirm=no_antivirus&id=1KtGAXbfUMp-lEvaryMRCcNURxNQYULRb) лица можно скачать по соответствующим ссылкам. Отправьте этот документ вашему персональному менеджеру или в чат бизнес-поддержки на сайте личного кабинета.   
...
## <p align="center">**Развернутая информация о товаре**<p align="center">  
...
<p align="center">
  ...
  <img width="900" height="400" src="https://i.gyazo.com/8dd336c47d01d882ee83b1399602902b.jpg">
...
# Инструкция по заполнению Бриф-заявки для ЦПТ   
Для того, чтобы сформировать заявку на ЦПТ, вам необходимо заполнить шаблон брифа. Точно заполненный бриф поможет нам верно понять ваши задачи и рассчитать предварительную стоимость услуг, поэтому ознакомьтесь с этой инструкцией.   
...
# 9. Добавление сотрудников в личный кабинет  
...
- Номер телефона сотрудника, с помощью которого он будет входить в личный кабинет. Номер должен быть зарегистрирован на платформе KazanExpress в качестве аккаунта покупателя или продавца.  
...
<p align="center">
  ...
  <img width="560" height="510" src="https://user-images.githubusercontent.com/93249146/148737340-5f91e1cf-e1a5-4c92-a486-600a9bf7cb1f.gif">

</p>

На данный момент доступны роли:  
➖ **Управляющий магазином** — может пользоваться всем функционалом управления магазином за исключением вывода денежных средств.  
...
➖ **Сотрудник поддержки** — в случае необходимости сотрудник технической поддержки KazanExpres сможет просматривать товары, скидки с таймерами, промокоды, просматривать отзывы и отвечать на них, если вы предоставите доступ.  
➖ **Работник центра подготовки товаров** — в рамках данной роли сотрудники склада KazanExpress могут создавать накладные и штрихкоды, а ЦПТ добавлять карточки товаров при этом не имея доступа к лишней информации. Обратите внимание, что добавление сотрудника в этом случае происходит автоматически, поэтому не беспокойтесь, если вы заметили в личном кабинете лишнего сотрудника под данным статусом.  
...
<p align="center">
  ...
  <img width="500" height="330" src="https://user-images.githubusercontent.com/93249146/148739436-a85aded8-d500-460c-97dd-dbf7d81ddd92.gif">
...
::: note  
**ВАЖНО!**  
**Дата сдачи товара на ПВЗ должна быть на день раньше выбранного тайм слота при создании акта приема-передачи!**     
:::  
...
Если вы уже зарегистрированы на платформе KazanExpress как покупатель, просто авторизуйтесь в бизнес-аккаунте при помощи логина и пароля от клиентского сайта (так как вы не сможете завести еще один аккаунт на тот же номер телефона или электронную почту). Если вы забыли пароль, то его можно восстановить нажав на кнопку “Забыли пароль?” при авторизации.   


<p align="center">

  <img width="450" height="300" src="https://i.gyazo.com/898ac64c0d46c00220ecc03da936bc7e.png">

</p>
При возникновении вопросов по регистрации и заполнению данных обращайтесь к [Менеджеру по сопровождению новых партнеров](https://t.me/KazanExpress_Helper_Bot).  вы



Регистрируясь на платформе, вы соглашаетесь с условиями [Договора оферты](https://business.kazanexpress.ru/agreement). Договор является отражением бизнес-процессов, прописанных в данной инструкции.  


ми [договора оферты](https://business.kazanexpress.ru/agreement). Дог
 к [менеджеру по сопровождению новых партнеров](https://t.me/KazanExpress_Helper_Bot).  
...
![фото](https://i.ibb.co/rvRCcfX/photo-2021-12-21-15-28-10.jpg)  
...
Если вы только что приобрели статус ИП или юридического лица, то перед регистрацией на сайте необходимо подождать три рабочих дня для того чтобы информация обновилась в базе ЕГРЮЛ.       

Поменять организационно-правовую форму после этого можно будет только через удаление аккаунта, поэтому будьте внимательны на этом этапе. В частности, если вы индивидуальный предприниматель с формой налогообложения НПД — то не нажимайте галочку “Я — самозанятый”.    

В нашей системе взаимоотношений есть несколько ролей:
1. Управляющий магазином — контактное лицо, которое отвечает за работу с площадкой. Может совпадать с ИП / ген. директором: в таком случае управляющий магазином и руководитель Юр.лица будут являться одним и тем же лицом.
2. ИП, ООО или иное юридическое лицо имеющее право заниматься реализацией товаров.
3. Сотрудник - пользователь, получивший доступ к личному кабинету, функционал 


Если человек, который будет управлять магазином, не совпадает с ИП/ген.директором ООО, то дополнительно необходимо прикрепить фото доверенности (шаблон доверенности можно скачать по [ссылке](https://drive.google.com/uc?export=download&confirm=no_antivirus&id=1cunLmWl_dtyCSZIVygTPIirx9yatfYB_)).    

Ниже представлен список необходимых документов для регистрации на маркетплейсе:    
➖ Для ИП:  
...
### <p align="center">Нанесение QR-кодов на товары<p align="center">  
...
<p align="center">
  ...
  <img width="450" height="450" src="https://i.gyazo.com/895175d341cc96c8e0ed9664b6db942a.png">

</p>

Также вы можете воспользоваться услугами нашего [Центра подготовки товаров](https://packing.kazanexpress.ru/) (ЦПТ).  Для этого вам нужно передать нам QR коды в личном кабинете в системе “Честный знак”, а также выслать их в  CSV или PDF формате своему персональному менеджеру или в чат бизнес-поддержки на сайте личного кабинета. Далее ЦПТ упаковывает товар  и наносит QR код. 

### <p align="center">Перемаркировка после возврата<p align="center">  
...
Перемаркировать товар — значит выпустить новый код маркировки (КМ), нанести на этикетку с новым ДатаМатрикс и подать сведения об этом в систему «Честный ЗНАК». Инструкцию по перемаркировке товара вы можете найти по [ссылке](https://www.google.com/url?q=https://getmark.ru/blog/o-markirovke/kak-peremarkirovat-tovar-v-chestnom-znake-peremarkirovka-instrukciya/&sa=D&source=docs&ust=1639728165526000&usg=AOvVaw1bzHxG1JJ9ncBt6uOCAxae).   

Для того, чтобы нанести этикетки с новой маркировкой вам нужно либо [забрать товар со склада](https://business.kazanexpress.ru/manual/7.work/#_7-6-%D0%B2%D0%BE%D0%B7%D0%B2%D1%80%D0%B0%D1%82%D1%8B-%D1%82%D0%BE%D0%B2%D0%B0%D1%80%D0%BE%D0%B2-%D1%81%D0%BE-%D1%81%D0%BAn%D0%B0%D0%B4%D0%B0), либо воспользоваться [услугами ЦПТ](https://packing.kazanexpress.ru/). 
